...
clf = DecisionTreeClassifier(max_depth=1, random_state=2)


benchmark(clf, X_train, X_test, y_train, y_test, 'DecisionTreeClassifier')
#drawPlots(clf, X_train, X_test, y_train, y_test, 'DecisionTreeClassifier')
